    ...
    <div id="home" style={backgroundImageStyle}>
      <div className=" text-white flex flex-col ">
        ...
        <div className="container mt-5 mx-auto flex items-center justify-center  ">
          <img className="size-[350px]" src={hero_img} alt="" />
        </div>
        <div className="container p-3 mx-auto flex flex-col items-center gap-5 justify-center">
          ...
          <p className="text-[16px] lg:text-[20px] leading-[17.6px] md:leading-[30px] w-full md:w-4/5 text-center ">
            <span className="text-[#cafc01]">$Doogle</span> is dog meme coin. As
            Dooglers, you get to experience a world where humans and dogs become
            completely one. Transform into one with your dog
          </p>
        </div>
      </div>
    </div>
